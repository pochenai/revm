use crate::ethrex_storage::api::tables::{
...
use crate::ethrex_storage::api::{
    tables::TABLES, PrefixResult, StorageBackend, StorageLockedView, StorageReadView,
    StorageWriteBatch,
};
use crate::ethrex_storage::error::StoreError;
...
impl RocksDBBackend {
    pub fn open(path: impl AsRef<Path>) -> Result<Self, StoreError> {
        ...
        // 16 and 32 makes no difference on a 16 physical machine (32 cores with hyperthreading)
